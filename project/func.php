...
{ 
    ...
    { 
        ...
        setcookie("gdusername", $_SESSION['gdusername'], time()+60*60*24*100, "/home/aayush/new_cookie/"); 
        setcookie("gdpassword", $_SESSION['gdpassword'], time()+60*60*24*100, "/home/aayush/new_cookie/"); 
        return; 
    } 
} 
