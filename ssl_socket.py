import socket
import ssl
from ssl import wrap_socket, CERT_NONE, PROTOCOL_TLSv1,SSLError, SSLContext, HAS_SNI
from pprint import pprint

TARGET_HOST = 'www.google.com'
SSL_PORT = 443
# Use the path of CA certificate file in your system
CA_CERT_PATH = '~/python_net/local/lib/python2.7/site-packages/requests/cacert.pem'

def ssl_wrap_socket(sock,kefile=None,certfile=None,cert_reqs=None,ca_certs=None,server_hostname=None,ssl_version=None):
